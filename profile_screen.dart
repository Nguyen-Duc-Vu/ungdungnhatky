...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  String? _avatarPath; // ← lưu đường dẫn ảnh avatar
  ...
  void _loadSettings() {
    try {
      ...
      setState(() {
        ...
        _avatarPath = box.get('avatarPath'); // ← load avatar
      });
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content:
          const Text('⚠️ Nhắc nhở chỉ hoạt động trên Android/iOS'),
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: isDark
                      ? [const Color(0xFF3D2B1A), const Color(0xFF2A1F14)]
                      : [const Color(0xFFB5835A), const Color(0xFF8B5E3C)],
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      _ProfileStat(
                          value: '${entries.length}', label: 'Bài viết'),
                      Container(
                          width: 1, height: 32,
